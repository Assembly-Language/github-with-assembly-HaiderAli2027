...
sumMsg byte "Sum of Odd Numbers is: ",0
CountMsg byte "Total number of Odd numbers are: ",0
...
Next:
    ...
    test dx,0001h               ; Test dx with 0001h to find the Odd number
    jz skip                     ; JUm to Skip on the basis of Zero Flag 
    add ax,dx                   ; Add the Odd numbers in eax
    inc ebx                     ; Count the total Odd numbers in ebx
